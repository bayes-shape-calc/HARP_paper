...
fws = np.logspace(np.log10(formula_weights.min()-1),np.log10(formula_weights.max()+1),35+1)
...
#
fig.savefig('figures/rendered/EPres_fw_2018_zoom.pdf')
fig.savefig('figures/rendered/EPres_fw_2018_zoom.png',dpi=300)
#
plt.show()
