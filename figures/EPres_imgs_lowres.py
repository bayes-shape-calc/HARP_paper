...
ps,mu_as,mu_bs,tau_as,tau_bs,covs = cf.process_sets_hierarchical(P_ress,'figures/models/hmodel_nparticles_lowres.hdf5',nres=5)
...
#
fig.savefig('figures/rendered/EPres_nparticles_lowres.pdf')
fig.savefig('figures/rendered/EPres_nparticles_lowres.png',dpi=300)
plt.close()
