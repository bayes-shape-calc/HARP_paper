...
ps,mu_as,mu_bs,tau_as,tau_bs,covs = cf.process_sets_hierarchical(P_ress,'figures/models/hmodel_nparticles.hdf5',nres=5)
...
# ax['T'].set_xlabel(r'Number of Particles in Reconstruction')

fig.tight_layout()
fig.subplots_adjust(bottom=.22)
#
fig.savefig('figures/rendered/EPres_nparticles.pdf')
fig.savefig('figures/rendered/EPres_nparticles.png',dpi=300)
plt.close()
