...
ps,mu_as,mu_bs,tau_as,tau_bs,covs = cf.process_sets_hierarchical(P_res_journal,nres=5)
...
#
fig.savefig('figures/rendered/EPres_journal_2018.pdf')
fig.savefig('figures/rendered/EPres_journal_2018.png',dpi=300)
plt.show()
